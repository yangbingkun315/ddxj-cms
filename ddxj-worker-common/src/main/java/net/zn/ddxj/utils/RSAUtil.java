...
public class RSAUtil {
	...
	public static String publicKey = "MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBALHChLL9t4sytfOIRQNsZuqiFJBs2hSoLC04AUf+/azKVGHQHkXNcFKHa+kvmzMionC/1Hy2GTp5TMnyjEKb50UCAwEAAQ=="; // 公钥
	public static String privateKey = ""; // 私钥
	...
	public static void generateKey() {
		...
		try {
			...
			// 进行转码
			System.out.println("公钥生成："+Base64.encodeBase64String(rsaPublicKey.getEncoded()));
			// 进行转码
			System.out.println("私钥生成："+Base64.encodeBase64String(rsaPrivateKey.getEncoded()));
