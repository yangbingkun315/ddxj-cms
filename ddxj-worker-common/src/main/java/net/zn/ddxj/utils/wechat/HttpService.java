...
public class HttpService {
	...
	public static String Post(String xml, String url, boolean isUseCert,int timeout) throws WxPayException {
		...
		// System.getProperties().put("proxyHost", "proxy.ehuatai.com");
		// System.getProperties().put("proxyPort", "808");

		// 如果需要验证用户
		// Authenticator.setDefault(new
		// MyAuthenticator("pi_net_shsz","b4ZwhDtL"));
