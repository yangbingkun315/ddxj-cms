...
public class RequestUtils
{
    ...
    public static void excuteHttpGetRequest(String url)
    {
		try
		{
    ...
    public static Integer getQueryIntParam(HttpServletRequest request, String name)
    {
    	String param = getQueryParam(request,name);
    	if(!CmsUtils.isNullOrEmpty(param) && CmsUtils.isNumber(param))
    	{
    ...
    {
    	return "true".equals(request.getParameter("ajaxHttpRequest")) || "XMLHttpRequest".equals(request.getHeader("X-Requested-With"));
    }
    ...
    public static boolean isFromIOSApp(HttpServletRequest  request)
    {
    	boolean isFromIOSApp = false;
    	String userAgent = request.getHeader("User-Agent");
    	if(userAgent != null && userAgent.indexOf("vedingBrigdeForiPhone") > -1)
    	{
    		isFromIOSApp = true;
    	}
    	return isFromIOSApp;
    }
    public static boolean isFromAndroidApp(HttpServletRequest  request)
    {
    	boolean isFromAndroidApp = false;
    	String userAgent = request.getHeader("User-Agent");
    	if(userAgent != null && userAgent.indexOf("vedingBrigdeForAndroid") > -1)
    	{
    ...
    public static boolean isFromApp(HttpServletRequest  request)
    {
    	...
    	String userAgent = request.getHeader("User-Agent");
    	if(userAgent != null && userAgent.indexOf("vedingBrigde") > -1)
    	{
    		isFromApp = true;
    	}
    	return isFromApp;
