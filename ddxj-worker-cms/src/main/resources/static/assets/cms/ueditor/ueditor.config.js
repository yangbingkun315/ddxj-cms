...
(function () {
     ...
     */
	window.UEDITOR_HOME_URL = alyCms.base.getRootPath() + "/assets/cms/ueditor/"; 
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: alyCms.base.getRootPath() + "/cms/ueditor/config.htm"
		...
		,whiteList: {
			...
			u:      [],
			ul:     ['class', 'style'],
			video:  ['autoplay', 'controls', '_src','_url','loop', 'preload', 'src', 'height', 'width', 'class', 'style'],
			source: ['src', 'type'],
