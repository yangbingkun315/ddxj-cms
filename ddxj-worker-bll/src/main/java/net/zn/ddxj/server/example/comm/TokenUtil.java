...
public class TokenUtil {
    public static String GRANT_TYPE = PropertiesUtils.getPropertiesByName("GRANT_TYPE");
    private static String CLIENT_ID = PropertiesUtils.getPropertiesByName("CLIENT_ID");
    private static String CLIENT_SECRET = PropertiesUtils.getPropertiesByName("CLIENT_SECRET");
    private static Token BODY = new Token().clientId(CLIENT_ID).grantType(GRANT_TYPE).clientSecret(CLIENT_SECRET);
