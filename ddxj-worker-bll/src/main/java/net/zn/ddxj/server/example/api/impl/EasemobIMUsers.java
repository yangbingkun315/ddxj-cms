...
import net.zn.ddxj.easemob.server.example.api.IMUserAPI;
...
public class EasemobIMUsers  implements IMUserAPI {
	...
	@Override
	public Object createNewIMUserSingle(final Object payload,String token) {
		return responseHandler.handle(new EasemobAPI() {
			@Override
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameUsersPost(OrgInfo.ORG_NAME,OrgInfo.APP_NAME, (RegisterUsers) payload,token);
			}
		});
	}

	@Override
	public Object createNewIMUserBatch(final Object payload,String token) {
		return responseHandler.handle(new EasemobAPI() {
			@Override
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameUsersPost(OrgInfo.ORG_NAME,OrgInfo.APP_NAME, (RegisterUsers) payload,token);
	...
	@Override
	public Object modifyIMUserNickNameWithAdminToken(final String userName,final Object payload,String token) {
		return responseHandler.handle(new EasemobAPI() {
			@Override
			public Object invokeEasemobAPI() throws ApiException {
				return api.orgNameAppNameUsersUsernamePut(OrgInfo.ORG_NAME,OrgInfo.APP_NAME,userName, (Nickname) payload,token);
			}
		});
	}
